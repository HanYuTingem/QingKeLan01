...
- (IBAction)UbuttonSender:(UIButton *)sender
{
    ...
    switch (sender.tag) {
        ...
        case 5://帮助
        {
            self.rulesTextView.text = @"关注青海广播电视台经济生活频道精彩节目\n积极参与有奖互动！\n每天当您看青海广播电视台经济生活频道电视节目\n屏幕下方出现“摇一摇”图标时\n即可参加我们的即时摇奖活动\n在同一次活动中每个用户都可以摇奖一次参与摇奖\n即摇即中\n赶快来赢取您的超级大奖吧";
...
- (void) shareDefalutMessage
{
    ...
    self.shareContent = [NSString stringWithFormat:@"小伙伴们,我在使用青稞蓝app中摇一摇呢~ 快来青稞蓝跟我一起摇出大奖吧 (来自于青稞蓝App) http://qkl.sinosns.cn/"];
}
