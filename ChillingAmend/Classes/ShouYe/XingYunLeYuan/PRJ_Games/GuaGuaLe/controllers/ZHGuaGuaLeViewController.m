...
{
    self.shareContent = [NSString stringWithFormat:@"伙伴们!我要开始刮奖了!来祝我好运吧!我在青稞蓝App~ (来自于青稞蓝App) http://qkl.sinosns.cn/"];
...
-(void)initiation:(id)sender{
    ...
    if (guaGuaArray.count > 0) {
        for (int i = 0; i < [guaGuaArray count]; i++) {
            ...
            nameLabel.textColor = [UIColor colorWithRed:254.0/255 green:187.0/255 blue:38.0/255 alpha:1.0];
