...
//
//        socialData.shareText =   [NSString stringWithFormat:@"小伙伴们,我正在参与青稞蓝app里的幸运转盘,快来青稞蓝跟我一起转出大奖吧~(来自于青稞蓝App) http://qkl.sinosns.cn/"];
//
//    }
//
//}
...
{
    self.shareContent = @"什么??!!! 这个转盘里面竟然有我一直想要的...简直不敢相信!! 快来围观!!! http://qkl.sinosns.cn/";
