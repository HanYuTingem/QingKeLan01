...
@property (nonatomic, strong) SINOActionListViewController * grapeKnowledgeViewController; // 青海活动
...
//    self.homeTabBar = [GAHomeTabBar loadFromXib];
    ...
    self.homeTabBar.backgroundColor = [UIColor colorWithRed:254.0 / 255 green:187.0 / 255 blue:38.0 / 255 alpha:1];
    //[UIColor colorWithRed:254 green:187 blue:38 alpha:1];
