...
- (void)callOutShareGoodS:(LSYGoodsInfo*)goods
{
    ...
    //    self.shareContent = [NSString stringWithFormat:@"%@商城里的%@，真心不错啊!快来看看吧! http://qkl.sinosns.cn/",@"青稞蓝",goods.name];
    
    NSString *shareURL = [NSString stringWithFormat:@"%@#/share/common/%@/%@",imageViewUrl,goods.goods_id,PROINDEN];
