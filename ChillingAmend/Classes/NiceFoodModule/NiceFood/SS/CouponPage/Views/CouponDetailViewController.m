...
- (void)downLodendData{
    NSDictionary *parameter = @{@"couponId":_couponId,@"proIden":PROIDEN,@"oId":UserId,@"phone":PhoneNumber};
...
-(void)sendBtn:(id)sender{
    ...
    NSString * urlStr = [NSString stringWithFormat:@"%@coupon?couponId=%@&productId=2&merchantId=%@",Http01,xiangModel.couponId,self.ownerId];
