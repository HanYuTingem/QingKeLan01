...
- (void)DownddateMode{
    ...
    NSDictionary *parameter = @{@"oId":UserId,@"state":buttonFlagStr,@"page":pageFlagStr,@"rows":@"10",@"proIden":PROIDEN,@"phone":PhoneNumber};
...
- (DZNSegmentedControl *)createControlWithItems:(NSArray*)items
{
    if (!_control)
    {
        ...
        _control.tintColor = RGBCOLOR(254, 187, 38);
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (alertView.tag == 101) {//分享
        if (buttonIndex == 1) {
            NSLog(@"从这里处理跳转的任务");
            NSDictionary *parameter = @{@"oId":UserId,@"proIden":PROIDEN,@"phone":PhoneNumber};
