...
//    [UMSocialData defaultData].extConfig.wechatSessionData.title = @"来自天天乐玩APP客户端";
    ...
    [UMSocialData defaultData].extConfig.qzoneData.title = @"来自青稞蓝APP客户端";
    [UMSocialData defaultData].extConfig.qqData.title = @"来自青稞蓝APP客户端";
    [UMSocialData defaultData].extConfig.wechatSessionData.title = @"来自青稞蓝APP客户端";
...
//    [UMSocialWechatHandler setWXAppId:@"wx08d78379377cc3e8" appSecret:@"f8052085ce493a6c6caf50199b3ef80a" url:idStr];
    [UMSocialWechatHandler setWXAppId:@"wx6d0909c80b91d3b3" appSecret:@"" url:idStr];
    //设置分享到QQ空间的应用Id，和分享url 链接
//    [UMSocialQQHandler setQQWithAppId:@"1103967875" appKey:@"SOETiOBnRcnlY3Jd" url:idStr];
    [UMSocialQQHandler setQQWithAppId:@"1101224913" appKey:@"sLPV0fKCWIVYXy3r" url:idStr];
    NSString *contentTitle = @"";
    if ([content isEqualToString:@""]) {
//        contentTitle = @"天天乐玩是最火爆的电视、观众互动神器，多种互动玩法，瞬间收礼收到爆！马上注册天天乐玩，和我一起赢取丰富奖品呦~~。加下载微门户地址（点击进入下载微门户页面，页面上有当前用户的唯一邀请码）。";
        contentTitle = [NSString stringWithFormat:@"%@ %@ %@",title,@"青稞蓝 青海人的生活娱乐电商平台",idStr];
    }else{
        //设置分享内容
