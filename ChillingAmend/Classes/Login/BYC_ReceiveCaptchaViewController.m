...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    if ([GCUtil isMobileNumber:numberTextField.text] != 0&&validationTextView.text.length == 6) {
        [confirmButton setBackgroundColor:[UIColor colorWithRed:254.0 / 255 green:187.0 / 255 blue:38.0 / 255 alpha:1.00f]];
...
-(void)theCountdown:(NSTimer *)timer{
    if (timeInt < 1) {
        [timer invalidate];
        [validationButton setBackgroundColor:[UIColor colorWithRed:254.0 / 255 green:187.0 / 255 blue:38.0 / 255 alpha:1.00f]];
